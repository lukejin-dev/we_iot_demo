...
public class GraphViewSeries {
	...
	private GraphViewDataAdapterInterface values; 
	private final List<GraphView> graphViews = new ArrayList<GraphView>();

	
	public GraphViewSeries(GraphViewDataAdapterInterface values) {
		description = null;
		style = new GraphViewSeriesStyle();
		this.values = values;
	}

	public GraphViewSeries(String description, GraphViewSeriesStyle style, GraphViewDataAdapterInterface values) {
		super();
	...
	public GraphViewDataAdapterInterface getData()
	{
		return values; 
	}
...
//	}
	 ...
	 */
	public void resetData(GraphViewDataAdapterInterface values) {
		this.values = values;
		for (GraphView g : graphViews) {
			g.redrawAll();
		}
